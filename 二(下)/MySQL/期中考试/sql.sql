...
insert into sa_考生号 (sno,ano,score) values("10000360","10011001",55);

alter table sa_考生号 add foreign key sa_考生号 (sno) references s_考生号 (sno) on update cascade on delete cascade;
